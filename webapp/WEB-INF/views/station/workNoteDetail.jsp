...
<body>
	<header class="am-topbar am-topbar-fixed-top">
		...
		<div class="am-topbar-brand  app-toolbar">工作备忘详情</div>
		</div>
	</header>
...
<script type="text/javascript">	
	function deleteStatioRecord(recordId){
		$('#finish-confirm').modal({
			relatedTarget : this,
			onConfirm : function() {
				var url="${ctx}/station/deleteStationRecord?recordId=" + recordId + "&stationId=${stationRecord.stationId}";
	...
	function goStationDetail() {
		var url="${ctx}/station/getStationDetail?jobId=4&stationId=${stationRecord.stationId}";
		window.location.href=url;
	}
