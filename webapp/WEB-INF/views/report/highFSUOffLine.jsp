...
<body>
	...
	<div class="am-alert am-text-lg am-text-center" style="padding:2px;margin-bottom:0px;">按次数统计FSU离线基站</div>
	<div class="am-scrollable-horizontal">
	  <table  class="am-table am-table-bordered am-table-striped am-table-hover am-text-center am-text-nowrap">
	    ...
	    <tbody id="fsuOffLineNumList">
		  <c:forEach var="obj" items="${fsuOffLineNumList}" varStatus="status">
		  	<tr id="${obj.offLineId}" onclick="responseText('${obj.offLineId}','${obj.reason}','${obj.statu}',this);">
		  		<td>
		  			<button id ="response_${obj.offLineId}" style="border:none;"><i class="am-icon-pencil-square-o" ></i></button>
		  		</td>
			    <td>${obj.county}</td>
	...
	<div class="am-alert am-text-lg am-text-center" style="padding:2px;margin-bottom:0px;">按时长统计FSU离线基站</div>
	<div class="am-scrollable-horizontal">
	  <table  class="am-table am-table-bordered am-table-striped am-table-hover am-text-center am-text-nowrap">
	    <thead>
		  <tr>
		    ...
		    <th style="text-align:center;">区县</th>
		    <th style="text-align:center;">基站名称</th>
		    <th style="text-align:center;">离线时长</th>
		    <th style="text-align:center;">是否解决</th>
		    <th style="text-align:center;">问题原因</th>
		    <th style="text-align:center;">代维公司</th>
		    <th style="text-align:center;">FSU厂商</th>
	    ...
	    <tbody id="fsuOffLineLengthList">
		  <c:forEach var="obj" items="${fsuOffLineLengthList}" varStatus="status">
		  	<tr id="${obj.offLineId}" onclick="responseText('${obj.offLineId}','${obj.reason}','${obj.statu}',this);">
		  		<td>
		  			<button id ="response_${obj.offLineId}" style="border:none;"><i class="am-icon-pencil-square-o" ></i></button>
		  		</td>
	...
	function responseText(id,reasonVal,statuVal,el){
		...
		$('#response-prompt').modal({
		      ...
		      onConfirm: function(e) {
		    	  ...
		    	  $.ajax({type:"POST",dataType:"json",url:'${ctx}/fourHight/updateHighFSUOffLine.json',
		  			data:{
		  				offLineId:idVal,
		  				reason:reason,
		  				statu:statu
