...
<body>
	...
	<div class="am-cf">
		<table class="am-table" style="padding:0px;margin: 0px;">
			<tbody>
				<c:forEach items="${daysReportList}" var="obj" varStatus="status">
					<tr onclick="toDaysReport('${obj.countyId}','${obj.mobileOperator}','${obj.num}','${obj.stationNum}');"  style="background: #fff;border-bottom:none;">
						<td style="border-top: none;border-bottom:none;vertical-align: middle;margin-bottom: 0px;padding-bottom: 0px;">
							<div class="am-text-truncate" ><font size='3'>${obj.countyId} 日报</font></div>
						</td>
					</tr>
...
<script type="text/javascript">
	function toDaysReport(day,timeLength,num,stationNum) {
		showLoading();
		window.location.href="${ctx}/report/toDaysReport?day="+day+"&timeLength="+timeLength+"&num="+num+"&stationNum="+stationNum;
	}
</script>
<center>
