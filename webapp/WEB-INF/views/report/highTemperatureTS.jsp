...
<body>
	...
	<div class="am-alert am-text-lg am-text-center" style="padding:2px;margin-bottom:0px;">按次数统计超高温基站</div>
	  ...
	  <table  class="am-table am-table-bordered am-table-striped am-table-hover am-text-center am-text-nowrap">
	    <thead>
		  <tr>
		    ...
		    <th style="text-align:center;">高温告警次数</th>
	    ...
	    <tbody id="highHighTemperatureNumList">
		  <c:forEach var="obj" items="${highHighTemperatureNumList}" varStatus="status">
	...
	<div class="am-scrollable-horizontal">
	  <table  class="am-table am-table-bordered am-table-striped am-table-hover am-text-center am-text-nowrap">
	    ...
	    <tbody id="highHighTemperatureLengthList">
		  <c:forEach var="obj" items="${highHighTemperatureLengthList}" varStatus="status">
		  	<tr id="${obj.highTemperatureId}" onclick="responseText('${obj.highTemperatureId}','${obj.reason}','${obj.statu}',this);">
		  		<td>
		  			<button id ="response_${obj.highTemperatureId}" style="border:none;" ><i class="am-icon-pencil-square-o" ></i></button>
		  		</td>
	...
	function responseText(id,reasonVal,statuVal,el){
		...
		$('#response-prompt').modal({
		      ...
		      onConfirm: function(e) {
		    	  ...
		    	  $.ajax({type:"POST",dataType:"json",url:'${ctx}/fourHight/updateHighHighTemperatureTS.json',
		  			data:{
