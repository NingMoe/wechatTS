...
<script type="text/javascript">
	var url1 = '/quarterInspection/readyStartTask';
	
	var stationId1 = '${s_station.stationId}';
	
	function startJob(){
		showLoading();
		window.location.href = "${ctx}/quarterInspection/toStart";
	}
	function continueJob(){
		showLoading();
		window.location.href = "${ctx}/quarterInspection/toContinueTask";
	}
	function finishJob() {
		showLoading();
				...
				$("#finish-confirm").modal(
					{
						...
						onConfirm : function(options) {
							window.location.href="${ctx}/quarterInspection/finish?status=1";
						},
						onCancel : function() {
							//do nothing
						}
...
<body>
	<header class="am-topbar am-topbar-fixed-top">
		...
		<div class="am-topbar-brand  app-toolbar">季度巡检</div>
		</div>
	</header>
