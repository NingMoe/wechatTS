...
public class SignUtil {
	// 与接口配置信息中的Token要一致
    //public static final String Token = "bobo123456";
     ...
     *  @return
     */
    public static String  checkAuthentication(String signature,String timestamp,String nonce,String echostr,String token) {
        String result ="";
        // 将获取到的参数放入数组
