 ...
 *getExtendResource(StringrelativePath)方法，可以使�?./符号来加载classpath外部的资源�?
 */
public class ClassLoaderUtil {
     ...
     *@throwsMalformedURLException
     ...
     /**
       *
       *@paramrelativePath 必须传�?资源的相对路径�?是相对于classpath的路径�?如果�?��查找classpath外部的资源，�?��使用../来查�?
       *@return资源的绝对URL
     *@throwsMalformedURLException
       */
    ...
    public static void main(String[] args) throws MalformedURLException {
        ...
        System.out.println(ClassLoaderUtil.getAbsolutePathOfClassLoaderClassPath().toString());
